...
export var SCHEMAS = {
  Visit: {
    ...
    sheet: 'Visit',
    fields: [
      { name: 'tanggal', label: 'Tanggal Visit', type: 'date', required: true, group: 'header' },
      { name: 'customer', label: 'Nama Customer', type: 'customerSelect', required: true, group: 'header' },
      { name: 'produk', label: 'Nama Produk', type: 'productSelect', required: true, group: 'product' },
      { name: 'qty', label: 'AMS Qty (Zak/Bal)', type: 'number', required: true, group: 'product' },
      { name: 'supplierType', label: 'Supplier Type', type: 'select', optionsKey: 'SupplierType', options: ['Distributor', 'Grosir'], required: true, group: 'product' },
      { name: 'supplierName', label: 'Supplier Name', type: 'text', group: 'product' },
      { name: 'stokSupplier', label: 'Stok Supplier', type: 'select', optionsKey: 'StokSupplier', options: ['Ready', 'Out of Stock'], group: 'product' },
      { name: 'hargaBeli', label: 'Harga Beli', type: 'number', group: 'product' },
      { name: 'hargaJual', label: 'Harga Jual', type: 'number', group: 'product' },
      { name: 'tujuan', label: 'Tujuan', type: 'textarea', group: 'header' },
      { name: 'issue', label: 'Issue', type: 'textarea', group: 'header' },
      { name: 'actionPlan', label: 'Action Plan', type: 'textarea', group: 'header' },
      { name: 'timeline', label: 'Timeline', type: 'text', group: 'header' },
      { name: 'asmVisit', label: 'ASM Visit', type: 'select', options: ['Ya', 'Tidak'], group: 'header' },
      { name: 'tcdVisit', label: 'TCD Visit', type: 'select', options: ['Ya', 'Tidak'], group: 'header' }
    ]
  },
  NonVisit: {
    label: 'Non Visit',
